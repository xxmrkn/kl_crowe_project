...
def main():
    ...
    model = ViT(
    image_size = 256, #256*256->65,536
    patch_size = 32,  #32*32->1,024
    ...
    visualize_plot_loss(plot_train_loss,
                plot_valid_loss)
    visualize_plot_acc(plot_train_acc,
                plot_valid_acc)
    visualize_plot_f1(plot_train_f1,
                plot_valid_f1)
